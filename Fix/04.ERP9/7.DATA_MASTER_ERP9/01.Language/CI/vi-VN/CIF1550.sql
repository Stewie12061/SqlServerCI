...
SET @LanguageValue  = N'Danh mục giá vốn dự kiến'
...
EXEC ERP9AddLanguage @ModuleID, 'CIF1550.InventoryTypeID',  @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'CIF1550.InventoryTypeID.CB',  @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Tên loại mặt hàng';
EXEC ERP9AddLanguage @ModuleID, 'CIF1550.InventoryTypeName.CB',  @FormID, @LanguageValue, @Language;