...
EXEC ERP9AddLanguage @ModuleID, 'EDMF2072.GradeNameFrom', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Lớp';
EXEC ERP9AddLanguage @ModuleID, 'EDMF2072.ClassNameFrom', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ghi chú';
EXEC ERP9AddLanguage @ModuleID, 'EDMF2072.Notes', @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'EDMF2072.Attach.GR' , @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ghi chú';
EXEC ERP9AddLanguage @ModuleID, 'EDMF2072.Notes.GR' , @FormID, @LanguageValue, @Language;