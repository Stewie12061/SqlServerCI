...
EXEC ERP9AddLanguage @ModuleID, 'POSF3017.VoucherNo' , @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Pile bill number';
EXEC ERP9AddLanguage @ModuleID, 'POSF3017.DeVoucherNo' , @FormID, @LanguageValue, @Language;
