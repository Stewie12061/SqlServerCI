...
SET @LanguageValue = N'Cập nhật tiến độ nhận hàng';
...
EXEC ERP9AddLanguage @ModuleID, 'POF2101.AnaID.CB',  @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Tên loại'
EXEC ERP9AddLanguage @ModuleID, 'POF2101.AnaName.CB',  @FormID, @LanguageValue, @Language;
