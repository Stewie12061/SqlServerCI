...
EXEC ERP9AddLanguage @ModuleID, N'SOF2024.SumAmount', @FormID,@LanguageValue, @Language;

SET @LanguageValue =  N'Choose quotation';
EXEC ERP9AddLanguage @ModuleID, N'SOF2024.Title', @FormID, @LanguageValue, @Language;
...
SET @LanguageValue = N'Quotation Status';
