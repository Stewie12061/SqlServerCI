...
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.ConvertedQuantity' , @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Đã giao';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.ShippedAmount' , @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 3';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity03', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 4';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity04', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 5';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity05', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 6';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity06', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 7';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity07', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 8';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity08', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 9';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity09', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 10';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity10', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 11';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity11', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 12';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity12', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 13';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity13', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 14';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity14', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 15';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity15', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 16';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity16', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 17';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity17', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 18';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity18', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 19';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity19', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 20';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity20', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 21';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity21', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 22';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity22', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 23';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity23', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 24';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity24', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 25';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity25', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 26';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity26', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 27';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity27', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 28';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity28', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 29';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity29', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngày 30';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.Quantity30', @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Ngày giao'
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.DeliveryDate',  @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'% chiết khấu khuyến mãi';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.PromotePercent', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Mã combo';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.KITID' , @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Số lượng combo';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.KITQuantity' , @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Giá đề nghị';
EXEC ERP9AddLanguage @ModuleID, 'SOF2002.RetailPrice' , @FormID, @LanguageValue, @Language;