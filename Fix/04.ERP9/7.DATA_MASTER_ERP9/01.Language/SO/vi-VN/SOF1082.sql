...
SET @LanguageValue = N'Xem chi tiết kế hoạch doanh số (Sell In)';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.Title', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Thông tin chỉ tiêu doanh số nhân viên';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.ThongTinChiTieuDoanhSoNV', @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.Description', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Thông tin chi tiết chỉ tiêu doanh số năm';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.ThongTinChiTietChiTieuDSYear', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Nhân viên';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.EmployeeName', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Cấp nhân viên';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.EmployeeLevelName', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Đối tượng';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.ObjectName', @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.DepartmentName', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Tổ nhóm';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.TeamName', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Tên SA - PG';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.SOAna01Name', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Tên SUP';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.SOAna02Name', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Tên ASM';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.SOAna03Name', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Tên ADMIN';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.SOAna04Name', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Tên QLADMIN';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.SOAna05Name', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Ngành hàng (MPT 8)';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.InventoryTypeName', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Nhóm hàng (MPT 4)';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.InventoryTypeName2', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Doanh số tháng';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.SalesMonth', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Kế hoạch cùng kỳ';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.SalesMonthOld', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Doanh số quý';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.SalesQuarter', @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.StatusID', @FormID, @LanguageValue, @Language;


SET @LanguageValue = N'Tháng';
EXEC ERP9AddLanguage @ModuleID, 'SOF1082.Month', @FormID, @LanguageValue, @Language;
