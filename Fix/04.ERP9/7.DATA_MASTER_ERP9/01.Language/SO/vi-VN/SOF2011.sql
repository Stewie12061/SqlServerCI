...
SET @LanguageValue = N'Thành tiền trước thuế';
 ...
 EXEC ERP9AddLanguage @ModuleID, 'SOF2011.RequireDate' , @FormID, @LanguageValue, @Language;
 
  SET @LanguageValue = N'Ngày giao hàng tiến độ';
 EXEC ERP9AddLanguage @ModuleID, 'SOF2011.ScheduleDate' , @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'SOF2011.Danh_sach_mat_hang',  @FormID, @LanguageValue, @Language;