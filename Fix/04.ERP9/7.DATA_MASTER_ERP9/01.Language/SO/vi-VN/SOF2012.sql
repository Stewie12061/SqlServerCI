...
SET @LanguageValue = N'Tiền chiết khấu nguyên tệ';
 ...
 SET @LanguageValue = N'Chiết khấu DS';
...
SET @LanguageValue = N'Thành tiền trước thuế';
 ...
 EXEC ERP9AddLanguage @ModuleID, 'SOF2012.RequireDate' , @FormID, @LanguageValue, @Language;
 
  SET @LanguageValue = N'Ngày giao hàng tiến độ';
 EXEC ERP9AddLanguage @ModuleID, 'SOF2012.ScheduleDate' , @FormID, @LanguageValue, @Language;
