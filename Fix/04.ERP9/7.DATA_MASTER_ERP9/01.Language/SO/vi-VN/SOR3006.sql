...
SET @FormID = 'SOR3006'
SET @LanguageValue = N'Báo cáo doanh số trung bình theo nhân viên';
...
EXEC ERP9AddLanguage @ModuleID, 'SOR3006.AccountName' , @FormID, @LanguageValue, @Language;

SET @FormID = 'SOR3006'
SET @LanguageValue = N'Nhân viên';
EXEC ERP9AddLanguage @ModuleID, 'SOR3006.SalesManName' , @FormID, @LanguageValue, @Language;
