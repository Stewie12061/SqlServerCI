...
SET @LanguageValue = N'Xem chi tiết tiến độ giao hàng';
...
-- 01/11/2022 Đình Định: Thêm địa chỉ giao
SET @LanguageValue = N'Địa chỉ ';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.Address', @FormID, @LanguageValue, @Language;

---- 08/02/2023 Viết Toàn: Thêm số PO

SET @LanguageValue = N'Tham số 01';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar01' , @FormID, @LanguageValue, @Language;

  SET @LanguageValue = N'Tham số 02';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar02' , @FormID, @LanguageValue, @Language;

  SET @LanguageValue = N'Tham số 03';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar03' , @FormID, @LanguageValue, @Language;

  SET @LanguageValue = N'Tham số 04';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar04' , @FormID, @LanguageValue, @Language;

  SET @LanguageValue = N'Tham số 05';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar05' , @FormID, @LanguageValue, @Language;

  SET @LanguageValue = N'Tham số 06';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar06' , @FormID, @LanguageValue, @Language;

  SET @LanguageValue = N'Tham số 07';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar07' , @FormID, @LanguageValue, @Language;

  SET @LanguageValue = N'Tham số 08';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar08' , @FormID, @LanguageValue, @Language;

  SET @LanguageValue = N'Tham số 09';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar09' , @FormID, @LanguageValue, @Language;

  SET @LanguageValue = N'Tham số 10';
EXEC ERP9AddLanguage @ModuleID, 'SOF2102.nvarchar10' , @FormID, @LanguageValue, @Language;
