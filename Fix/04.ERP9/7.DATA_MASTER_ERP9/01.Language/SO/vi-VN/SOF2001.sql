...
SET @LanguageValue = N'Số đơn hàng';
 ...
 EXEC ERP9AddLanguage @ModuleID, 'SOF2001.UnitName' , @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.Orders.CB',  @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Địa chỉ giao hàng'
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.DeliveryAddress.CB',  @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.KITID' , @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Số lượng combo';
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.KITQuantity' , @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Giá đề nghị';
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.RetailPrice' , @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.Vi_chiet_khau_tich_luy' , @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.ManagerCostPaid' , @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Mã'
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.ConvertedUnitID.CB',  @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Tên'
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.ConvertedUnitName.CB',  @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Toán tử'
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.DataTypeName.CB',  @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Cách tính'
EXEC ERP9AddLanguage @ModuleID, 'SOF2001.FormulaDes.CB',  @FormID, @LanguageValue, @Language;