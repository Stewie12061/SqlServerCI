...
SET @FormID = 'SOR3004'
SET @LanguageValue = N'Báo cáo tổng doanh số bán hàng theo mặt hàng';
...
EXEC ERP9AddLanguage @ModuleID, 'SOR3004.AccountName' , @FormID, @LanguageValue, @Language;

SET @FormID = 'SOR3004'
SET @LanguageValue = N'Nhân viên';
EXEC ERP9AddLanguage @ModuleID, 'SOR3004.SalesManName' , @FormID, @LanguageValue, @Language;

SET @FormID = 'SOR3004'
SET @LanguageValue = N'Sản phẩm';
EXEC ERP9AddLanguage @ModuleID, 'SOR3004.InventoryName' , @FormID, @LanguageValue, @Language;
