...
SET @LanguageValue  = N'Thành tiền qui đổi';
...
EXEC ERP9AddLanguage @ModuleID, 'SOF2021.UnitID.CB',  @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Tên đơn vị'
EXEC ERP9AddLanguage @ModuleID, 'SOF2021.UnitName.CB',  @FormID, @LanguageValue, @Language;

SET @LanguageValue  = N'Hàng khuyến mãi'
EXEC ERP9AddLanguage @ModuleID, 'SOF2021.IsProInventoryID',  @FormID, @LanguageValue, @Language;
