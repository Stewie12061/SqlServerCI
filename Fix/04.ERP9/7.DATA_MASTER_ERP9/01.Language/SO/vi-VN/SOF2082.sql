...
SET @LanguageValue = N'Thông tin bán thành phẩm';
...
EXEC ERP9AddLanguage @ModuleID, 'SOF2082.ProductID', @FormID, @LanguageValue, @Language;
...
SET @LanguageValue = N'Thông tin rã nguyên vật liệu';
...
SET @LanguageValue = N'Khổ file cpt/bản in/Dài ';
...
SET @LanguageValue = N'Bằng';
EXEC ERP9AddLanguage @ModuleID, 'SOF2082.FileSum', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Bao gồm';
EXEC ERP9AddLanguage @ModuleID, 'SOF2082.FileUnitName', @FormID, @LanguageValue, @Language;
...
EXEC ERP9AddLanguage @ModuleID, 'SOF2082.NodeTypeName', @FormID, @LanguageValue, @Language;