...
--- Chuẩn: Ngày làm việc trong tuần
--- BlueSky: Ngày nghỉ trong tuần
IF EXISTS(SELECT TOP 1 * FROM CustomerIndex WHERE CustomerName = 91)
BEGIN
	SET @LanguageValue = N'Ngày nghỉ trong tuần';
	EXEC ERP9AddLanguage @ModuleID, 'OOF0031.TabOOT0032', @FormID, @LanguageValue, @Language;
END
ELSE
BEGIN
	SET @LanguageValue = N'Ngày làm việc trong tuần';
	EXEC ERP9AddLanguage @ModuleID, 'OOF0031.TabOOT0032', @FormID, @LanguageValue, @Language;
END


SET @LanguageValue = N'Thời gian tính phí';
EXEC ERP9AddLanguage @ModuleID, 'OOF0031.TabOOT0034', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Từ ngày';
EXEC ERP9AddLanguage @ModuleID, 'OOF0031.DayStart', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Đến ngày';
EXEC ERP9AddLanguage @ModuleID, 'OOF0031.DayEnd', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Tính theo ngày';
EXEC ERP9AddLanguage @ModuleID, 'OOF0031.IsDay', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Giá trị (%)';
EXEC ERP9AddLanguage @ModuleID, 'OOF0031.PercentValue', @FormID, @LanguageValue, @Language;
