...
EXEC ERP9AddLanguage @ModuleID, 'OOF0032.StatusID', @FormID, @LanguageValue, @Language;
...
SET @LanguageValue = N'Danh sách ngày nghỉ trong tuần';
...
EXEC ERP9AddLanguage @ModuleID, 'OOF0032.OOT0034', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Từ ngày';
EXEC ERP9AddLanguage @ModuleID, 'OOF0032.DayStart', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Đến ngày';
EXEC ERP9AddLanguage @ModuleID, 'OOF0032.DayEnd', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Tính theo ngày';
EXEC ERP9AddLanguage @ModuleID, 'OOF0032.IsDay', @FormID, @LanguageValue, @Language;

SET @LanguageValue = N'Giá trị (%)';
EXEC ERP9AddLanguage @ModuleID, 'OOF0032.PercentValue', @FormID, @LanguageValue, @Language;
