IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[CMNP90171]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[CMNP90171]
GO
...
-- <Example>
/*
    EXEC CMNP90171 'AS', '','PHUONG',1,25
*/

 CREATE PROCEDURE CMNP90171 (
...
DECLARE @sSQL NVARCHAR (MAX),
	...
	SET @sSQL = '
				...
				WHERE DivisionID = '''+@DivisionID+''' AND AnaTypeID = ''S05'' And Disabled=0
				'+@sWhere+' ) OT1002
				ORDER BY ' + @OrderBy + '
