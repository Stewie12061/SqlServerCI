IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[CMNP90141]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[CMNP90141]
GO
...
----Modified on 29/05/2023 by Anh Đô: Cập nhật điều kiện lọc
-- <Example>
/*
    EXEC CMNP90141 'AS', '','PHUONG',1,25
*/

 CREATE PROCEDURE CMNP90141 (
...
DECLARE @sSQL NVARCHAR (MAX),
	...
	SET @sSQL = '
				...
				WHERE DivisionID IN ('''+@DivisionID+''', ''@@@'') AND [Disabled] = 0 AND AnaTypeID =''I08''	
				'+@sWhere+' ) AT1015
				ORDER BY ' + @OrderBy + '
