IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[CMNP90111]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[CMNP90111]
GO
...
-- <Summary>
--- Load màn hình chọn nhân viên (SUP)
-- <Param>
----
-- <Return>
----
...
-- <Example>
/*
    EXEC CMNP90111 'AS', '','PHUONG',1,25
*/

 CREATE PROCEDURE CMNP90111 (
...
DECLARE @sSQL NVARCHAR (MAX),
	...
	SET @sSQL = '
				...
				WHERE DivisionID = '''+@DivisionID+''' AND AnaTypeID = ''S02'' And Disabled=0
				'+@sWhere+' ) OT1002
				ORDER BY ' + @OrderBy + '
