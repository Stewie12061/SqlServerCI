IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[CMNP90121]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[CMNP90121]
GO
...
-- <Summary>
--- Load màn hình chọn nhân viên (ASM)
-- <Param>
----
-- <Return>
----
...
-- <Example>
/*
    EXEC CMNP90121 'AS', '','PHUONG',1,25
*/

 CREATE PROCEDURE CMNP90121 (
...
DECLARE @sSQL NVARCHAR (MAX),
	...
	SET @sSQL = '
				...
				WHERE DivisionID = '''+@DivisionID+''' AND AnaTypeID = ''S03'' And Disabled=0
				'+@sWhere+' ) OT1002
				ORDER BY ' + @OrderBy + '
