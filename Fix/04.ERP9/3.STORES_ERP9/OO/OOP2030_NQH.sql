IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[OOP2030_NQH]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[OOP2030_NQH]
GO
...
/*-- <Example>
	OOP2030_NQH @DivisionID='MK',@UserID='000454',@PageNumber=1,@PageSize=25,@IsSearch=1, @TranMonth=8, @TranYear=2016,
...
SET @sSQL =' 
	...
	(
		SELECT OOT90.APK, OOT90.DivisionID,OOT90.TranMonth, OOT90.TranYear, OOT90.ID,
		       ...
		       OOT90.SubsectionID, OOT90.ProcessID, OOT90.Status,
...
SET @sSQL1='
		...
		'+@sWhere+'
		GROUP BY OOT90.APK, OOT90.DivisionID,OOT90.TranMonth, OOT90.TranYear, OOT90.ID,OOT90.Status,
		       OOT90.[Description], OOT90.DepartmentID, OOT90.SectionID,
...
IF @IsSearch = 1 AND @Status IS NOT NULL
	SET @sSQL1=@sSQL1+'
	HAVING MIN(OOT90.Status) LIKE ''%'+@Status+'%'' '
