IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[OOP2042]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[OOP2042]
GO
...
-- <Summary>
---- Load thông tin master Đơn xin bổ sung/hủy quẹt thẻ
-- <Param>
---- 
-- <Return>
---- 
...
---- 
/*
   EXEC OOP2042 @DivisionID='MK',@UserID='ASOFTADMIN',@APKMaster='FA590A1D-04AF-4B81-9CA2-00FA758DBB58',@TranMonth=8,@TranYear=2016
*/
CREATE PROCEDURE OOP2042
( 
...
SET @OrderBy = ''
SELECT TOP 1 @TranMonth=ISNULL(TranMonth,0), @TranYear=ISNULL(TranYear,0) FROM OOT9000 WHERE APK = @APKMaster
...
SET @sSQL ='
	SELECT	OOT90.APK, OOT90.DivisionID, A051.UserName CreateUserName, OOT90.TranMonth, OOT90.TranYear, OOT90.ID, OOT90.[Description],
