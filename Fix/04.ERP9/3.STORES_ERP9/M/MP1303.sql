IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[MP1303]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[MP1303]
GO
...
----
-- <History>
----Created by: Trọng Kiên 23/03/2021
-- <Example>
/*
    EXEC MP1303 'AS', '','PHUONG',1,25
*/

 CREATE PROCEDURE MP1303 (
