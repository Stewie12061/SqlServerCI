IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[HRMP3007]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[HRMP3007]
GO
...
---- 
/*-- <Example>
	EXEC [HRMP3007] @DivisionID='AS',@DivisionList='',@UserID='ASOFTADMIN',@FromDate='01-01-2016',@ToDate='01-01-2018',@TrainingFieldID='CNTT',@TrainingType='1',@TrainingPlanID='000001',@lstTransactionID='606F9FA8-C610-4FF4-BBAC-06E6B7F8937A'',''B1FF6B1A-8572-4F56-9149-E7F3FA9B0884'
----*/

CREATE PROCEDURE [HRMP3007]
( 
...
HRMT1040.TrainingFieldName, HT0099.Description AS TrainingTypeName, HRMT2130.FromDate, HRMT2130.ToDate,
SUM(HRMT2100.ScheduleAmount) AS ScheduleAmount, COUNT(HRMT2101.TransactionID) AS ScheduleNumber, COUNT(HRMT2121.TransactionID) AS RealityNumber, 
SUM(HRMT2130.CostAmount) AS RealityAmount, SUM(HRMT2091.ProposeAmount) AS ProposeAmount, COUNT(HRMT2091.TransactionID) AS NumberPropose
...
HRMT1050.TrainingCourseID, HRMT1050.Description, HRMT1040.TrainingFieldName, HT0099.Description, HRMT2130.FromDate, HRMT2130.ToDate
