...
SET @sSQL = ' 		
SELECT HRMT1050.APK, CASE WHEN HRMT1050.DivisionID = ''@@@'' THEN NULL ELSE HRMT1050.DivisionID END AS DivisionID, 
TrainingCourseID, HRMT1050.TrainingFieldID, HRMT1040.TrainingFieldName, TrainingType, HT0099.Description AS TrainingTypeName, 
HRMT1050.ObjectID, AT1202.ObjectName, HRMT1050.Address, HRMT1050.Description, HRMT1050.Disabled, HRMT1050.IsCommon,
...
HRMT1050.CreateUserID +'' - ''+ (SELECT TOP 1 UserName FROM AT1405 WHERE UserID = HRMT1050.CreateUserID) CreateUserID, HRMT1050.CreateDate, 
HRMT1050.LastModifyUserID +'' - ''+ (SELECT TOP 1 UserName FROM AT1405 WHERE UserID = HRMT1050.LastModifyUserID) LastModifyUserID, HRMT1050.LastModifyDate
...
AND TrainingCourseID = ''' + @TrainingCourseID + ''''
