...
SET @sSQL = N'SELECT AT1101.DivisionName, HRMT2080.TrainingRequestID,AT1103.fullname AS AssignedToUserName,
			...
			, N''Đã duyệt'' AS IsConfirmName,
			HRMT1040.TrainingFieldName,HRMT2080.NumberEmployee,HRMT2080.TrainingFromDate,HRMT2080.TrainingToDate,
			...
			FROM HRMT2080 
			JOIN AT1101 ON AT1101.DivisionID = HRMT2080.DivisionID
			JOIN AT1103 ON AT1103.employeeID = HRMT2080.AssignedToUserID
			JOIN HRMT1040 ON HRMT1040.TrainingFieldID = HRMT2080.TrainingFieldID
			WHERE  '+ @sWhere +''
EXEC (@sSQL)
