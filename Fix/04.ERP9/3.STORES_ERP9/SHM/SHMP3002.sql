IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[SHMP3002]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[SHMP3002]
GO
...
-- <Summary>
---- Báo cáo cổ tức phải trả – SHMR3002
---- 
-- <Param>
---- 
-- <Return>
...
-- <History>
-- <Example> EXEC SHMP3002 'HCM', 'HCM', 1, '2017-01-01', '2018-12-31', '12/2017'',''01/2018'',''02/2018','','', 'ASOFTADMIN'

CREATE PROCEDURE SHMP3002 
(
