IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WITH(NOLOCK) WHERE ID = OBJECT_ID(N'[DBO].[EDMP2062]') AND OBJECTPROPERTY(ID, N'IsProcedure') = 1)
DROP PROCEDURE [DBO].[EDMP2062]
GO
...
---- 
/*-- <Example>
	EDMP2062 @DivisionID = 'VS', @UserID = 'ASOFTADMIN', @APK = 'DF74CDCC-89B8-40F3-90A3-58353EB3147A', @LanguageID ='vi-VN'

	EDMP2062 @DivisionID, @UserID, @APK, @LanguageID
----*/
CREATE PROCEDURE EDMP2062
( 
...
SET @sSQL = @sSQL + N'
	SELECT T1.APK, T1.EvaluetionID, T1.EvaluetionDate, 
