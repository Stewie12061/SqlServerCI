IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'CRMP10703') AND OBJECTPROPERTY(ID, N'IsProcedure') = 1)
DROP PROCEDURE CRMP10703
GO
...
GO
-- <Summary>
---- Load Grid Form CRMP10703 IN Danh muc lĩnh vực kinh doanh
-- <Param>
---- 
-- <Return>
---- 
...
-- <Example>
----    EXEC CRMP10703 'AS','AS','','','','','0','NV01'
----
CREATE PROCEDURE CRMP10703 ( 
...
SET @sWhere = ''
SET @OrderBy = 'M.BusinessLinesID, M.BusinessLinesName'
