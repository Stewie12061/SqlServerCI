IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WITH (NOLOCK) WHERE ID = OBJECT_ID(N'[DBO].[WMP00034_ALL]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[WMP00034_ALL]
GO
...
--- Purpose: Tính giá xuất kho bình quân liên hoàn tất cả kho - Kế thừa từ store AP1410_ALL
--- Modified by ... on ...

CREATE PROCEDURE  [dbo].[WMP00034_ALL]
