IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[CIP14901]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[CIP14901]
GO
...
-- <Summary>
---- Load Grid Form CIF1490 Danh mục mã phân tích đơn hàng bán
-- <Param>
---- 
-- <Return>
---- 
...
---- 
-- <History>
----Created by: Hoài Bảo, Date: 16/12/2022
----Modified by: Hoài Bảo, Date: 19/12/2022 - Bổ sung điều kiện check MPT đang sử dụng -> load danh sách mã phân tích đơn hàng bán
-- <Example>
----    EXEC CIP14901 '1B','','','',1,20

CREATE PROCEDURE CIP14901 (
...
DECLARE @sSQL NVARCHAR (MAX),
	...
	SET @sWhere = 'AND (OT1002.AnaTypeID LIKE ''S%'')'
