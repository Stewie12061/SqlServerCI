IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[CIP1145]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[CIP1145]
GO
...
----
-- <History>
----Created by: Hoài Bảo 25/07/2022
-- <Example>
/*
    EXEC CIP1145 'AS', '','PHUONG',1,25
*/

 CREATE PROCEDURE CIP1145 (
