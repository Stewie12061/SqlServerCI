/****** Object:  StoredProcedure [dbo].[CIP1150_DELETE]    Script Date: 10/17/2020 6:11:00 PM ******/
IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[CIP1150_DELETE]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[CIP1150_DELETE]
GO
SET ANSI_NULLS ON
GO
...
-- <Example> EXEC CIP1150_DELETE 'VNP', '', '6486CC3C-4733-4889-BDA4-7FDA1F78DFF9', 'CIT1150', 1, NULL,'ASOFTADMIN'

CREATE PROCEDURE [dbo].[CIP1150_DELETE] (
...
BEGIN
	...
	BEGIN
		SET @sSQL = '
				...
				BEGIN
					EXEC CIP90000 @DelDivisionID, NULL, ''' + @TableID + ''', @DelMachineID, @Status OUTPUT
