IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[SOP20221]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[SOP20221]
GO
...
--	<Example>
/*	
	SOP20221 'DTI', '9b5883af-54aa-48c3-a0c1-99708a391bc6', 'BAOTOAN'
*/
--	</Example>
create proc SOP20221 
...
begin
	...
	select M.InventoryID,M.UnitID,M.Quantity,M.UnitPrice , OrderIndex
	from @tableData M 
		left join AT1302 R01 with (nolock) on M.InventoryID = R01.InventoryID
	where RIGHT(M.InventoryID,@len_Sign_NC) = @sign_NC	
