IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[MP1002_DUCPHAT]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)     
DROP PROCEDURE [DBO].[MP1002_DUCPHAT]  
GO  
...
---- Modified by Văn Tài	 on 05/02/2021: Tách store cho khách hàng DUCPHAT. không kiểm tra kho.

CREATE PROCEDURE MP1002_DUCPHAT
