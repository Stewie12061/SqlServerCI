...
'********************************************/
----- Modify on 02/12/2015 by Phương Thảo: Bỏ điều kiện where theo Đối tượng TPCP (PeriodID), vô từng store con sẽ bổ sung sau (customize Meiko)
----- Modified by Tiểu Mai on 18/01/2016: Bổ sung trường hợp thiết lập quản lý theo quy cách hàng hóa.
----- Modified by Bảo Thy on 24/05/2016: Bổ sung WITH (NOLOCK)
----- Modified by Phương Thảo on 06/06/2016: Chỉnh sửa trường hợp PerfectRate lưu = 0 (ResultTypeID = ''R01'')  
----- Modified by Bảo Anh on 24/04/2017: Đưa phần insert dữ liệu MT2222 vào các store bên trong để tính được Số lượng SPDD = Số lượng SP * ISNULL(% TLHT của từng loại chi phí, % TLHT chung)
...
--			INNER JOIN AT1302 WITH (NOLOCK) ON AT1302.DivisionID = D10.DivisionID AND AT1302.InventoryID = D10.ProductID
...
--			D10.UnitID, 
--			D08.PeriodID,    
--			SUM(D10.Quantity*D10.PerfectRate/100) AS ProductQuantity,	
--			O99.S01ID, O99.S02ID, O99.S03ID, O99.S04ID, O99.S05ID, O99.S06ID, O99.S07ID, O99.S08ID, O99.S09ID, O99.S10ID,
--			O99.S11ID, O99.S12ID, O99.S13ID, O99.S14ID, O99.S15ID, O99.S16ID, O99.S17ID, O99.S18ID, O99.S19ID, O99.S20ID
--		FROM MT1001 D10  WITH (NOLOCK)
--			INNER JOIN MT0810 D08 WITH (NOLOCK) ON D08.DivisionID = D10.DivisionID AND D08.VoucherID = D10.VoucherID
...
EXEC MP0621 @DivisionID, @UserID, @PeriodID, @TranMonth, @TranYear, @DistributionID

------- Phan bo Nhan cong truc tiep
EXEC MP0622 @DivisionID, @UserID, @PeriodID, @TranMonth, @TranYear, @DistributionID

--- Phan bi chi phi san xuat chung
EXEC MP0627 @DivisionID, @UserID, @PeriodID, @TranMonth, @TranYear, @DistributionID
