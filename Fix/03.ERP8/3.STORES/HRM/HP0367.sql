IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[HP0367]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[HP0367]
GO
...
Set @sSQL = N' 
			...
			LEFT JOIN AT0099 ON AT0099.ID = HT1411.IsConfirm01 AND AT0099.CodeMaster = ''AT00000011''
...
ELSE 
	Set @sSQL = N' 
			...
			WHERE HT1411.DivisionID = '''+@DivisionID+'''
				...
				AND HT1411.DepartmentID LIKE '''+@DepartmentID+'''
				AND HT1411.DutyID LIKE '''+@DutyID+'''
				AND HT1411.IsConfirm01 = 1 --AND IsConfirm02 <> 1
'
EXEC (@sSQL)
--PRINT (@sSQL)
