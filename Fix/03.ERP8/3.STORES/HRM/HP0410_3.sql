IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[HP0410_3]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[HP0410_3]
GO
...
/*
 * EXEC HP0410_3 'BBL', 12, 2016
 * 
 */

CREATE PROCEDURE HP0410_3
( 
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[BBL_HP04103]') AND TYPE IN (N'U'))
BEGIN
	CREATE TABLE BBL_HP04103 (TrackingID NVARCHAR(50))
END

DELETE FROM BBL_HP04103

INSERT INTO BBL_HP04103
...
SUM(ISNULL(H11.Quantity,0)) AS Quantity
INTO #HT0410_3
...
INNER JOIN BBL_HP04103 BBL ON BBL.TrackingID = H10.TrackingID
