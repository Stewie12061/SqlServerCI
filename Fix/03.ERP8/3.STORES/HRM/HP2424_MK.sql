IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[HP2424_MK]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[HP2424_MK]
GO
...
CREATE PROCEDURE [dbo].[HP2424_MK]  
...
Set @sSQL1 = 'Select Distinct H00.DivisionID, H00.AbsentTypeID, Caption, Orders, UnitID    
  From '+@TableHT2402+' H00 inner join HT1013 H01 on H00.AbsentTypeID = H01.AbsentTypeID and H00.DivisionID = H01.DivisionID    
...
If not exists (Select 1 From sysObjects Where XType = 'V' and Name = 'HV2415')    
 exec('Create view HV2415 ----tao boi HP2424_MK    
   as ' + @sSQL1)    
else    
 exec('Alter view HV2415 ----tao boi HP2424_MK    
   as ' + @sSQL1)    
...
Set @sSQL2 = N'Select  H00.DivisionID, H00.DepartmentID,H00.TeamID , AT00.DepartmentName, H00.EmployeeID, FullName,     
 ...
 From '+@TableHT2402+'  H00  inner join HV1400 HV00 on HV00.EmployeeID = H00.EmployeeID and HV00.DivisionID = H00.DivisionID     
...
/*    
Union    
Select  H00.DivisionID, ''zzzzzzzz'' as DepartmentID, ''TO�NG CO�NG'' as DepartmentName, '''' as EmployeeID, '''' asFullName,     
...
If not exists (Select  1 From sysObjects Where XType = 'V' and Name = 'HV2424')    
 exec('Create view HV2424 ----tao boi HP2424_MK    
   as '+ @sSQL2)    
else    
 exec('Alter view HV2424 ----tao boi HP2424_MK    
   as ' + @sSQL2)
