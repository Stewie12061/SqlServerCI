IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP8163]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP8163]
GO
...
---- Modified on 14/11/2022 by Văn Tài     : Điều chỉnh thành store AP8163
---- 
-- <Example>
/* 
 AP8163 @DivisionID = 'VG', @UserID = 'ASOFTADMIN', @ImportTemplateID = 'SalesOrder', @XML = ''
 */
 
CREATE PROCEDURE AP8163
( 
