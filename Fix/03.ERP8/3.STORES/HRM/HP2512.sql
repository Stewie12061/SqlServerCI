...
---Edit by Văn Tài, date 13/01/2020 -- Bổ sung Alter table bổ sung cột DivisionID cho trường hợp bảng đã được thêm.
...
---- Modified by Hoài Phong on 03/12/2020: Tách sp cho VAN KHANH
...
IF @CustomerName = 39 -- VAN KHANH
	EXEC HP2512_VANKHANH @DivisionID, @FromDepartmentID, @ToDepartmentID,@TeamID,@FromEmployeeID,@ToEmployeeID,@FromYear,@FromMonth,@ToYear,@ToMonth,@lstPayrollMethodID,@GrossPay,@Deduction,@IncomeTax,@gnLang,@Condition,@lstEmployeeID,@StrDivisionID
ELSE
