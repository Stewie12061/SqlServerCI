...
---- Modified by Đình Định on 05/01/2024: Bổ sung sắp xếp theo Mã NV.
-- <Example>
/*
	exec HP03341 'MK',1
*/
...
BEGIN
	...
	FROM HT0334 H34 WITH (NOLOCK)
		LEFT JOIN HV1400 V40 WITH (NOLOCK) ON V40.DivisionID = H34.DivisionID AND V40.EmployeeID = H34.EmployeeID
