IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP1309_KoYo]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP1309_KoYo]
GO
...
--------- Modified by Nhật Thanh on 12/07/2022: Bổ sung UnitPrice2
...
CREATE PROCEDURE [dbo].[AP1309_KoYo] 
