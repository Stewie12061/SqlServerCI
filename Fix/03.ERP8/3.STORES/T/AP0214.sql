...
'********************************************/
---AP0214 'HT','','',1,2017,1,2017,'20170101','20170131',0,'','',1
...
BEGIN
	EXEC AP0214_BBL @DivisionID, @FromWareHouseID,
					@ToWareHouseID,
				    @FromMonth,@FromYear,
				    @ToMonth, @ToYear,
				    @FromDate, @ToDate,
				    @IsDate, @FromInventoryID,
				    @ToInventoryID, @IsInner, ----- (0; khong co VCNB, 1: VCNB),
				    @UserID
END
ELSE
BEGIN
...
B.ConvertedAmount AS DeAmount, E.ActualQuantity AS ReQuantity, E.ConvertedAmount AS ReAmount, B.ReVoucherID, D.VoucherNo AS ReVoucherNo, D.VoucherDate AS ReVoucherDate, 
...
Set @sSQLSelect_A ='Select AV0244.*, AT1303.WareHouseName,
