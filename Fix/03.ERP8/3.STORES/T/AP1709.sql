IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP1709]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP1709]
GO
...
---- Created by Như Hàn on 21/09/2018: Đổ nguồn Combo Chứng từ
---- Modified by ... on ...
/**********************************************
** Edited by: 
***********************************************/

--EXEC AP1709 @DivisionID=N'KVC',@TranMonth=9,@TranYear=2018,@D_C=N'C'

CREATE PROCEDURE [dbo].[AP1709] 
...
SELECT T02.VoucherID, T02.VoucherNo, T02.VoucherDate, T02.VDescription, T02.AccountID, 
	  ...
	  Left Join AV1701 T01 on T01.DivisionID = T02.DivisionID And T01.VoucherID = T02.VoucherID
