IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP0081_QDN]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP0081_QDN]
GO
...
---- Modified by Lê Hoàng on 09/09/2020: trả ABParameter02 AS UnitPriceStandard (Quý Dần)
---- Modified by Nhựt Trường on 02/10/2020: (Sửa danh mục dùng chung)Bổ sung điều kiện DivisionID IN cho bảng AT1302.
-- <Example>
/*
	AP0081_QDN 'PC', '', 'TV23711baf-f6f4-46ec-a4a5-d2d4ff6ad904'
*/
CREATE PROCEDURE AP0081_QDN
(
...
BEGIN
	SELECT A90.VoucherID,  A90.BatchID, A90.TransactionID, A90.TableID, A90.DivisionID, A90.TranMonth, A90.TranYear,
		A90.TransactionTypeID, A90.CurrencyID, A90.ObjectID, A90.VATObjectID, A90.VATObjectName, A90.VATNo, A90.VATObjectAddress,
		...
		Isnull(A90.IsStock,0) AS IsStock, ISNULL(A90.ABParameter02,0) AS UnitPriceStandard
