IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP9024]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP9024]
GO
...
---- 
-- <Example>
---- EXEC AP9024 N'TN', 'ASOFTADMIN', N'CT01', N'CT01',N'AB00000', N'YM00215', N'0', N'Z0000Z001',
----			1, '', '', '', '', '', ''

CREATE PROCEDURE AP9024
( 
...
SET @sSQL1 = N'
	...
	LEFT JOIN AT1304 AS D04 WITH (NOLOCK) ON D02.DivisionID IN ('''+@DivisionID+''',''@@@'') AND D04.UnitID = D02.UnitID
...
SET @sSQL3 = N'	
	...
	LEFT JOIN AT1202 WITH (NOLOCK) ON AT1202.ObjectID = D16.ObjectID
	INNER JOIN AT1302 AS D02 WITH (NOLOCK) ON D02.DivisionID IN ('''+@DivisionID+''',''@@@'') AND D02.InventoryID = D17.InventoryID
	LEFT JOIN AT1304 AS D04 WITH (NOLOCK) ON D04.DivisionID IN ('''+@DivisionID+''',''@@@'') AND D04.UnitID = D02.UnitID
	INNER JOIN AT1303 AS D03 WITH (NOLOCK) ON D03.DivisionID IN ('''+@DivisionID+''',''@@@'') AND D03.WareHouseID = D16.WareHouseID
