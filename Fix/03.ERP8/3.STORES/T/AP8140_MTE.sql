IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP8140_MTE]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP8140_MTE]
GO
...
--Tao bang tam kiem tra co phai khach hang MEIKO khong (CustomerName = 50)
