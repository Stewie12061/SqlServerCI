IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WITH (NOLOCK) WHERE ID = OBJECT_ID(N'[DBO].[AP1410]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
...
--- Modified by Xuân Nguyên on 12/01/2023: [KRUGER][2023/01/IS/0024] Khi tính không áp giá lại cho phiếu có KindVoucherID = 10
--- Modified by Nhựt Trường on 06/02/2023: [2023/02/IS/0004] Mở lại điều kiện theo tài khoản khi lấy dữ liệu đầu kỳ.
'********************************************/
