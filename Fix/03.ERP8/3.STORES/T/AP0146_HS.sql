IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP0146_HS]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP0146_HS]
GO
...
-- AP0146_HS
-- <Summary>
---- Stored load dữ liệu hóa đơn phục vụ phát hành hóa đơn điện tử (Customize HOASANG): Luôn sử dụng dv tiền là VND
---- Created on 09/11/2020 by Đức Thông
-- <Param>
---- 
-- <Return>
---- 
...
CREATE PROCEDURE [dbo].[AP0146_HS]
...
DECLARE @sSQL AS NVARCHAR(MAX) = '',
	...
	ABS(AT9000.ConvertedPrice) * ABS(AT9000.ExchangeRate) AS ProdPrice, ABS(AT9000.ConvertedAmount) AS Amount,
