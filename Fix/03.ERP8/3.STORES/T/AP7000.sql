...
---- Modified by Bảo Thy on 27/07/2016: Bổ sung điều kiện tranmonth, tranyear khi left với AT0114
---- Modified by Phương Thảo on 15/05/2017: Sửa danh mục dùng chung
---- Modified by Tiểu Mai on 29/05/2017: Bổ sung TransactionID, điều kiện join ở AT0114
---- Modified by Bảo Anh on 05/04/2018: Bổ sung RDAddress
---- Modified by Nhựt Trường on 02/10/2020: (Sửa danh mục dùng chung)Bổ sung điều kiện DivisionID IN cho bảng AT1302.
---- Modified by Lê Hoàng on 21/10/2020: Nên dùng @DivisionID, lỗi không có dữ liệu với trường hợp db vừa lưu dùng chung vừa lưu dùng riêng 
---- Modified by Nhựt Trường on 05/04/2022: Bổ sung kiểm tra khi set giá trị câu truy vấn điều kiện thời gian.
---- Modified by Đức Duy on 13/02/2023: [2023/02/IS/0052] - Bổ sung thêm điều kiện DivisionID dùng chung cho bảng danh mục kho hàng - AT1303.
---- Modified by Nhật Thanh on 22/02/2023: Bổ sung lấy mã tham chiếu từ bảng mặt hàng
---- Modified by Đình Định on 11/08/2023: Lấy thêm cột ConvertedQuantity.
...
SELECT  D17.DivisionID, D17.TranMonth, D17.TranYear, D17.TransactionID,
	...
	0 AS CreditConvertedQuantity,NULL AS SParameter01,NULL AS SParameter02,NULL AS SParameter03	'
...
SELECT  D17.DivisionID, D17.TranMonth, D17.TranYear, D17.TransactionID,
	...
	ISNULL(D03.IsTemp,0) AS IsTemp, 0 AS KindVoucherID,
	(CASE WHEN  D17.TranMonth <10 then ''0''+rtrim(ltrim(str(D17.TranMonth)))+''/''+ltrim(Rtrim(str(D17.TranYear))) 
	Else rtrim(ltrim(str(D17.TranMonth)))+''/''+ltrim(Rtrim(str(D17.TranYear))) End) AS MonthYear,
	(''0''+ ltrim(rtrim(CASE WHEN D17.TranMonth %3 = 0 then D17.TranMonth/3  Else D17.TranMonth/3+1  End))+''/''+ltrim(Rtrim(str(D17.TranYear)))
	)  AS Quarter ,
...
SELECT  D07.DivisionID, D07.TranMonth, D07.TranYear, D07.TransactionID,
	...
	0 AS CreditConvertedQuantity,D06.SParameter01,D06.SParameter02,D06.SParameter03	'
...
SELECT  D07.DivisionID, D07.TranMonth, D07.TranYear, D07.TransactionID,
	...
	D07.MarkQuantity,
	0 AS DebitConvertedQuantity,
	D07.ConvertedQuantity AS CreditConvertedQuantity,D06.SParameter01,D06.SParameter02,D06.SParameter03 '
