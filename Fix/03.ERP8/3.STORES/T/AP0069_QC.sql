IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP0069_QC]') AND OBJECTPROPERTY(ID, N'IsProcedure') = 1)
DROP PROCEDURE [DBO].[AP0069_QC]
GO
...
-- <Summary>
---- Lấy dữ liệu hóa đơn bán hàng để lập hàng bán trả lại (AF0069) theo quy cách
-- <Param>
---- 
-- <Return>
---- 
...
-- <Example>
---- 
CREATE PROCEDURE [DBO].[AP0069_QC]
(
