IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP0146_THTP]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP0146_THTP]
GO
...
---- Created  by Văn Tài 	on 20/12/2019: Customize [THTP] convert AP0146 từ 18/12.
---- Modified by Văn Tài	on 27/12/2019: Điều chỉnh lại cách set giá trị cho chứng từ BDS.
...
DECLARE @sSQL01 AS NVARCHAR(MAX) = '',
		...
		@sSQL06_OPEN AS NVARCHAR(MAX) = '',
		@sSQL06_CLOSE AS NVARCHAR(MAX) = '',
		@sSQL06_PART_01 AS NVARCHAR(MAX) = '',
		@sSQL06_PART_02 AS NVARCHAR(MAX) = ''

BEGIN
	SET @sSQL01 = '     
	SELECT 
	ROW_NUMBER() OVER(ORDER BY AT9000.Orders) AS Remark
	, ISNULL(AT1202.EInvoiceObjectID, AT9000.ObjectID) AS CusCode
	, AT1202.ObjectName AS CusName
	, AT9000.VATObjectAddress AS CusAddress
	, AT1202.Tel AS CusPhone
	, AT1202.Email AS CusEmail
	, AT9000.VATNo AS CusTaxCode
	, AT1202.ObjectName AS Buyer
	, AT1202.TradeName AS CusbankNo
	...
	, ISNULL((SELECT SUM(ABS(DiscountAmount)) FROM AT9000 AT90 WITH (NOLOCK) WHERE AT90.DivisionID = AT9000.DivisionID AND AT90.VoucherID = AT9000.VoucherID AND TransactionTypeID IN (''T04'',''T24'',''T25'')), 0) 
	  + ISNULL(ABS(DiscountSalesAmount), 0) AS DiscountAmount
	...
	, CASE WHEN AT9000.VATGroupID = ''TS0'' THEN -1 ELSE AT1010.VATRate END AS VAT_Rate

' 
	SET @sSQL02 = ' 
	, AT9000.InventoryID AS ProdID
	, ISNULL(AT9000.InventoryName1, AT1302.InventoryName) AS ProdName
	, AT1304.UnitName AS ProdUnit
	, AT9000.Quantity AS ProdQuantity
	, ABS(AT9000.ConvertedPrice) AS ProdPrice
	, ABS(AT9000.ConvertedAmount) AS Amount
	, AT9000.InheritFkey
	, AT9000.EInvoiceType
	, AT9000.TypeOfAdjust
	...
	, AT9000.BDescription AS DonDatHangSo
	, ABS(AT9000.OriginalAmount) AS OriginalAmount
	, ISNULL(A02.AnaName + ''/'' + AT9000.VDescription, AT9000.VDescription) AS KindOfService
	...
	, AT9000.ExchangeRate
	, AT9000.UnitPrice
	, AT9000.OriginalAmount AS OriginalAmountAT9000
	...
	, AT9000.CommissionPercent
	, AT9000.InventoryName1
	, AT9000.PaymentTermID
	,
'
	SET @sSQL03 = N' AT9000.DiscountAmount AS DiscountAmountAT9000
	, AT9000.OTransactionID
	, AT9000.IsMultiTax
	, ABS(AT9000.VATOriginalAmount) AS VATOriginalAmount
	, ABS(AT9000.VATConvertedAmount) AS VATConvertedAmount
	, AT9000.ReVoucherID
	, AT9000.ReBatchID
	...
	, AT9000.MOrderID
	, AT9000.SOrderID
	, AT9000.MTransactionID
	, AT9000.STransactionID
	, AT9000.RefVoucherNo
	...
	, AT9000.InvoiceSign
	, AT9000.RefInfor
	, AT9000.StandardPrice
	, AT9000.StandardAmount
	, AT9000.IsCom
	, AT9000.VirtualPrice
	, AT9000.VirtualAmount
	, AT9000.ReTableID
	, AT9000.DParameter01
	, AT9000.DParameter02
	, AT9000.DParameter03
	...
	, AT9000.InheritTransactionID
	, AT9000.ETaxVoucherID
	, AT9000.ETaxID
	, AT9000.ETaxConvertedUnit
	, AT9000.ETaxConvertedAmount
	, AT9000.ETaxTransactionID
	, AT9000.AssignedSET
	, AT9000.SETID
	, AT9000.SETUnitID
	, AT9000.SETTaxRate
	, AT9000.SETConvertedUnit
	, AT9000.SETQuantity
	, AT9000.SETOriginalAmount
	, AT9000.SETConvertedAmount
	, AT9000.SETConsistID
	, AT9000.SETTransactionID
	, AT9000.AssignedNRT
	, AT9000.NRTTaxAmount
	, AT9000.NRTClassifyID
	, AT9000.NRTUnitID
	, AT9000.NRTTaxRate
	, AT9000.NRTConvertedUnit
	, AT9000.NRTQuantity
	, AT9000.NRTOriginalAmount
	, AT9000.NRTConvertedAmount
	, AT9000.NRTConsistID
	, AT9000.NRTTransactionID
	, AT9000.CreditObjectName
	, AT9000.CreditVATNo
	, AT9000.IsPOCost
	...
	, AT9000.IsFACost
	, AT9000.IsInheritFA
	, AT9000.InheritedFAVoucherID
	, AT9000.AVRExchangeRate
	, AT9000.PaymentExchangeRate
	, AT9000.IsMultiExR
	, AT9000.ExchangeRateDate
	, AT9000.DiscountSalesAmount
	, AT9000.IsProInventoryID
	, AT9000.InheritQuantity
	, AT9000.DiscountPercentSOrder
	, AT9000.DiscountAmountSOrder
	, AT9000.IsWithhodingTax
	, AT9000.IsSaleInvoice
	, AT9000.WTTransID
	, AT9000.DiscountSaleAmountDetail
	...
	, AT9000.ABParameter01
	, AT9000.ABParameter02
	, AT9000.ABParameter03
	, AT9000.ABParameter04
	, AT9000.ABParameter05
	, AT9000.ABParameter06
	, AT9000.ABParameter07
	, AT9000.ABParameter08
	, AT9000.ABParameter09
	, AT9000.ABParameter10
	, AT9000.SOAna01ID
	, AT9000.SOAna02ID
	, AT9000.SOAna03ID
	, AT9000.SOAna04ID
	, AT9000.SOAna05ID
	, AT9000.IsVATWithhodingTax
	, AT9000.VATWithhodingRate
	, AT9000.IsEInvoice
	, AT9000.EInvoiceStatus
	, AT9000.IsAdvancePayment
	, AT9000.Fkey
	, AT9000.IsInheritInvoicePOS
	, AT9000.InheritInvoicePOS
	, AT9000.IsInheritPayPOS
	, AT9000.InheritPayPOS
	, AT9000.IsInvoiceSuggest
	, AT9000.RefVoucherDate
	, AT9000.IsDeposit
	'
	SET @sSQL04 = '
	, AT9000.ReTransactionTypeID
	, AT9000.ImVoucherID
	, AT9000.ImTransactionID
	, AT9000.SourceNo
	, AT9000.LimitDate
	, AT9000.IsPromotionItem
	, AT9000.ObjectName1
	...
	, CASE AT9000.PaymentID WHEN ''TM'' THEN 1 WHEN ''CK'' THEN 2 WHEN ''TM/CK'' THEN 3 ELSE NULL END AS PayMethodID
	, AT9000.DiscountedUnitPrice
	, AT9000.ConvertedDiscountedUnitPrice
	, AT9000.IsReceived
	, A16.BankAccountNo
	, A16.BankName
	, A26.ContactPerson
	, ISNULL(AT1010.VATRate*AT9000.OriginalAmount / 100, 0) AS DVATOriginalAmount
	, ISNULL(AT1010.VATRate*AT9000.ConvertedAmount / 100, 0) AS DVATConvertedAmount
	, A13.UnitName AS ConvertedUnitName
	, A12.PaymentName
	, CASE WHEN TransactionTypeID = ''T64'' THEN 1 ELSE 0 END AS IsDiscount
	, A11.DivisionNameE
	, A11.AddressE
	, A11.District
	...
	, A27.SourceNo AS WSourceNo
	, CONVERT(NVARCHAR(10), A27.LimitDate, 103) AS WLimitDate
	, AT1302.I04ID
	, AT1015.AnaName AS I04Name
	...
	SET  @sSQL05 = N' 
		...
		-- Tổng tiền
		DECLARE @ConvertedAfterVATAmount DECIMAL(28, 8)
		-- Tổng tiền sau thuế từng dòng
		DECLARE @Amount DECIMAL(28, 8)
		
		SELECT TOP 1 
					  @Remark = Remark
					, @VoucherType = VoucherTypeID
					, @ConvertedAfterVATAmount = ConvertedAfterVATAmount
					, @Amount = Amount
		FROM #TEMP

		IF(@VoucherType = N''BDS'')
		BEGIN

			UPDATE #TEMP SET Total = @Amount

			UPDATE #TEMP 
			SET ConvertedAfterVATAmount = (SELECT SUM(ConvertedAfterVATAmount) FROM #TEMP)
				, Amount = (SELECT SUM(Amount) FROM #TEMP)
			WHERE
				Remark = @Remark
...
--PRINT(@sSQL05)
--PRINT(@sSQL06_OPEN)
--PRINT(@sSQL06_PART_01)
--PRINT(@sSQL06_PART_02)
--PRINT(@sSQL06_CLOSE)
