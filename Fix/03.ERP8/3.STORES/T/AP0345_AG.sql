IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP0345_AG]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP0345_AG]
GO
...
/*
exec AP0345_AG @DivisionID=N'ANG',@TranMonthFrom=2,@TranYearFrom=2017,@TranMonthTo=3,@TranYearTo=2017,@FromDate='2017-03-13 08:17:15.490',@ToDate='2017-03-13 08:17:15.490',
@IsDate=0,@AccountIDFrom=N'001',@AccountIDTo=N'N00',@Level1=0,@UserID=N'ASOFTADMIN',@StrDivisionID=N'ANG',@StrFinderMaster=N'1=1'
*/


CREATE PROCEDURE [dbo].[AP0345_AG]
...
IF @IsDate = 0
    BEGIN
        SET @strSQL = '
            ...
            FROM AV4310 AS V10 
            LEFT JOIN AT1005 AS T01 ON T01.AccountID = V10.LinkAccountID and T01.DivisionID = '''+@DivisionID+'''
        '
...
SET @strSQL = '
    ...
    FROM AV4310 AS V10 
    LEFT JOIN AT1005 AS T01 ON T01.AccountID = V10.CorAccountID and T01.DivisionID = '''+@DivisionID+''' '
...
SET @strSQL = '
    ...
    GROUP BY OpeningAmount, ClosingAmount, LinkAccountName, LinkAccountNameE, 
        LinkAccountID, AccumulatedDebit, AccumulatedCredit, CorAccountID, AccountName, 
        AccountNameE, AT1101.DivisionName
    ORDER BY LinkAccountID, CorAccountID '
