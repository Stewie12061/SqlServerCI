IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP0138]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP0138]
GO
...
---- Modified by Nhật Thanh on 13/04/2022:  Bổ sung điều kiện DivisionID dùng chung khi join bảng
-- <Param>

CREATE PROCEDURE [dbo].[AP0138] 
...
BEGIN
	...
	SET @sJoin = '
	LEFT JOIN AT1202 WITH (NOLOCK) ON AT1202.DivisionID in (''@@@'',V01.DivisionID) AND AT1202.ObjectID = V01.ObjectID'
	SET @sWhere = '
...
BEGIN
	...
	SELECT		DISTINCT V01.DivisionID, V01.BatchID, V01.ConvertedAmount, V01.TranMonth, V01.TranYear, V01.TableID, V01.Status,
				...
				' + @sSelect + '
				V01.TransactionTypeID, V01.VoucherDate, V01.VoucherID, V01.VoucherNo, --V01.VDescription as Description, 
				CASE WHEN V01.TransactionTypeID = ''T04'' THEN V01.VDescription ELSE V01.Description END AS Description,
	...
	GROUP BY	V01.DivisionID, V01.BatchID, V01.ConvertedAmount, V01.TranMonth, V01.TranYear, V01.TableID, V01.Status,
				...
				V01.TransactionTypeID, V01.VoucherDate, V01.VoucherID, V01.VoucherNo,CASE WHEN V01.TransactionTypeID = ''T04'' THEN V01.VDescription ELSE V01.Description END , 
				V01.Ana02ID, V01.Ana04ID, V01.Ana03ID		
	'	
END
ELSE
BEGIN
	...
	GROUP BY	V01.DivisionID, V01.BatchID, V01.ConvertedAmount, V01.TranMonth, V01.TranYear, V01.TableID, V01.Status,
				V01.AccountID, V01.CorAccountID, ' + @sGroupBy + '
				V01.TransactionTypeID, V01.VoucherDate, V01.VoucherID, V01.VoucherNo, V01.Ana02ID, CASE WHEN V01.TransactionTypeID = ''T04'' THEN V01.VDescription ELSE V01.Description END ,V01.Ana04ID, V01.Ana03ID		
	'		
END	
