IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WITH (NOLOCK) WHERE ID = OBJECT_ID(N'[DBO].[AP7407]') AND OBJECTPROPERTY(ID, N'IsProcedure') = 1)
...
---- Modified by Quốc Tuấn on 9/06/2016:Bổ sung thêm trường  Amount01Ana04ID, nhận dữ liệu từ mã phân tích
---- Modified by Tiểu Mai on 18/05/2017: Bổ sung chỉnh sửa danh mục dùng chung
---- Modified by Kim Thư on 11/02/2019: Bổ sung chỉnh sửa danh mục dùng chung ở điều kiện AccountID
---- Modified by Đức Thông on 19/03/2021: [Tiên Tiến] 2021/03/IS/0157: Lấy dữ liệu division được chọn trên báo cáo
/*
exec AP7407 @DivisionID=N'HT', @CurrencyID = 'VND',@FromAccountID=N'3311',@ToAccountID=N'357',@FromObjectID=N' 22247-B.TD*HBC',
