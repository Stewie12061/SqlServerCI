IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP0146_HTTC]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP0146_HTTC]
GO
...
-- AP0146_HTTC
-- <Summary>
---- Stored load dữ liệu hóa đơn phục vụ phát hành hóa đơn điện tử (customize Hạ tầng Tân Cảng)
---- Created on 11/12/2020 Đức Thông
-- <Param>
---- 
-- <Return>
---- 
...
---- 
-- <History>
--		Đức Thông	Created 11/12/2020		Customize Hạ tầng Tân Cảng (132): Lấy diễn giải bút toán (TDescription) là tên hàng (ProdName)
---- Modified by Đức Duy on 13/02/2023: [2023/02/IS/0052] - Bổ sung thêm điều kiện DivisionID dùng chung cho bảng danh mục kho hàng - AT1303.
---- Modified by Đức Duy on 20/02/2023: [2023/02/IS/0091] - Bổ sung thêm điều kiện DivisionID dùng chung cho bảng danh mục đối tượng - AT1202.

-- <Example>
---- EXEC AP0146_HTTC @DivisionID = 'ANG',@UserID='ASOFTADMIN',@VoucherID='AV561ee05d-44de-4d71-8e4c-4927876f60df'

CREATE PROCEDURE [dbo].[AP0146_HTTC]
...
'
	...
	ISNULL(AT9000.TDescription, AT1302.InventoryName) AS ProdName, 
	...
	AT9000.PaymentID as PayMethodID, AT9000.DiscountedUnitPrice, AT9000.ConvertedDiscountedUnitPrice, AT9000.IsReceived,
