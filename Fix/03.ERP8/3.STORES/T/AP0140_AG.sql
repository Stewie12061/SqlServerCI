IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP0140_AG]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP0140_AG]
GO
...
CREATE PROCEDURE [dbo].[AP0140_AG] 
...
BEGIN
	...
	INTO #TEMP2		   
	FROM #TEMP1	
	LEFT JOIN AT1011 WITH (NOLOCK) ON AT1011.DivisionID = #TEMP1.DivisionID AND AT1011.AnaID = #TEMP1.Ana04ID AND AT1011.AnaTypeID = ''A04''
...
BEGIN
	...
	INTO #TEMP2			   
	FROM #TEMP1	
	LEFT JOIN AT1011 WITH (NOLOCK) ON AT1011.DivisionID = #TEMP1.DivisionID AND AT1011.AnaID = #TEMP1.Ana06ID AND AT1011.AnaTypeID = ''A06''
