IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WITH (NOLOCK) WHERE ID = OBJECT_ID(N'[DBO].[AP7515_TIENTIEN]') AND OBJECTPROPERTY(ID, N'IsProcedure') = 1)
DROP PROCEDURE [DBO].[AP7515_TIENTIEN]
GO
...
---- Modified on 15/02/2022 by Nhựt Trường: Bổ sung kiều kiện DivisionID khi JOIN bảng AT1202.

CREATE PROCEDURE [dbo].[AP7515_TIENTIEN]  	
