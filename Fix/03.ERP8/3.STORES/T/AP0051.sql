IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AP0051]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[AP0051]
GO
...
BEGIN
	...
	AT1202.Note AS ObjectName, MAX(ISNULL(AT0161.SalesMonth,0)) AS SalesMonth02,
...
BEGIN
	...
	SET @sSQL1 = '
	SELECT #TEMP1.DivisionID, #TEMP1.ObjectID, AT1202.Note AS ObjectName, MAX(ISNULL(AT0161.SalesMonth,0)) AS SalesMonth02,
...
SET @sSQL2 = '
	SELECT #TEMP2.ObjectID, #TEMP2.ObjectName, SUM(ISNULL(#TEMP2.SalesMonth02,0)) AS SalesMonth02, 
