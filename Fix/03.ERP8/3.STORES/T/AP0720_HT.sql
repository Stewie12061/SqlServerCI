...
Select y.DivisionID,y.O05ID, y.ObjectAnaName5,y.InventoryID, y.InventoryName,
	...
	From
	(
		Select x.DivisionID,x.O05ID, x.ObjectAnaName5, x.InventoryID, x.InventoryName,
		...
		x.D_C in (''D'',''C'', ''BD'' )' 
		+ @sWhere +'
		Group by x.DivisionID,  x.O05ID, x.ObjectAnaName5, x.InventoryID, x.InventoryName
)y'
