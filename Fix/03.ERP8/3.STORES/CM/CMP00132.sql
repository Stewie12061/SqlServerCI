IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[CMP00132]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[CMP00132]
GO
...
SELECT C13.DivisionID
	...
	, NULL ComRate
	, NULL ComUnit
	, CONVERT(Decimal,C13.Quantity) AS Quantity
	, C13.UnitID
