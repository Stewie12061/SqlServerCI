IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[WP0097_QC]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[WP0097_QC]
GO
...
-- <Summary>
--- Load Grid khi kế thừa từ Phiếu yêu cầu nhâp xuất vcnb theo quy cách hàng hóa
-- <Param>
----
-- <Return>
----
...
----
-- <History>
----Created by Tiểu Mai on 24/05/2016
---- Modified on 02/06/2016 by Bảo Thy: Bổ sung WITH (NOLOCK)
---- Modified by Tiểu Mai on 01/09/2016: Fix bug số lượng quy đổi không đúng
---- Modified by Tiểu Mai on 12/09/2016: Bổ sung thêm ĐVT quy đổi
...
---- Modified by Thành Sang on 02/01/2024: - Bổ sung cột CarID, DriverID, Tên quy cách.
-- <Example>
/*
    EXEC WP0097 'EIS','','59AI20140000000008'
*/

 CREATE PROCEDURE WP0097_QC
(
...
--- Cac thong tin lien quan den DVT qui doi  cho 
	...
	(Isnull(WT0096.ConvertedQuantity,0) - Isnull(G.ActualConvertedQuantity,0)) AS ConvertedQuantity, WT0096.ConvertedPrice, isnull(WT0096.ConvertedUnitID,AT1302.UnitID) as ConvertedUnitID ,  isnull(T04.UnitName,AT1304.UnitName) as ConvertedUnitName,
...
--- CP khac	(yeu cau cua 2T)
	...
	O99.S11ID, O99.S12ID, O99.S13ID, O99.S14ID, O99.S15ID, O99.S16ID, O99.S17ID, O99.S18ID, O99.S19ID, O99.S20ID, WT0096.SOrderIDRecognition,
	...
	WT0095.SParameter15, WT0095.SParameter16, WT0095.SParameter17, WT0095.SParameter18, WT0095.SParameter19, WT0095.SParameter20,
	...
	WT0096.DriverID, WT0096.CarID, AT05.UserName as DriverName,
	AT0128_01.StandardName as S01Name,
	AT0128_02.StandardName as S02Name,
	AT0128_03.StandardName as S03Name,
	AT0128_04.StandardName as S04Name,
	AT0128_05.StandardName as S05Name,
	AT0128_06.StandardName as S06Name,
	AT0128_07.StandardName as S07Name,
	AT0128_08.StandardName as S08Name,
	AT0128_09.StandardName as S09Name,
	AT0128_10.StandardName as S10Name
'
...
LEFT JOIN AT1303 WITH (NOLOCK) on AT1303.DivisionID IN (''@@@'', ''' + @DivisionID + ''') AND AT1303.WareHouseID = WT0095.WareHouseID
LEFT JOIN AT1303 AT03 WITH (NOLOCK) on AT03.DivisionID IN (''@@@'', ''' + @DivisionID + ''') AND AT03.WareHouseID = WT0095.WareHouseID
...
LEFT JOIN AT1405 AT05 WITH (NOLOCK) ON AT05.DivisionID IN (''' +@DivisionID+ ''', ''@@@'') AND AT05.UserID = WT0096.DriverID
'
SET @sSQL3 = '
LEFT JOIN WT8899 O99 WITH (NOLOCK) ON O99.DivisionID = WT0096.DivisionID AND O99.VoucherID = WT0096.VoucherID AND O99.TransactionID = WT0096.TransactionID
LEFT JOIN AT1309 T09 WITH (NOLOCK) on T09.InventoryID = WT0096.InventoryID AND  WT0096.ConvertedUnitID = T09.UnitID AND
												Isnull(T09.S01ID,'''') = Isnull(O99.S01ID,'''') AND	Isnull(T09.S11ID,'''') = Isnull(O99.S11ID,'''') AND 
												Isnull(T09.S02ID,'''') = Isnull(O99.S02ID,'''') AND	Isnull(T09.S12ID,'''') = Isnull(O99.S12ID,'''') AND 
												Isnull(T09.S03ID,'''') = Isnull(O99.S03ID,'''') AND	Isnull(T09.S13ID,'''') = Isnull(O99.S13ID,'''') AND 
												Isnull(T09.S04ID,'''') = Isnull(O99.S04ID,'''') AND	Isnull(T09.S14ID,'''') = Isnull(O99.S14ID,'''') AND 
												Isnull(T09.S05ID,'''') = Isnull(O99.S05ID,'''') AND	Isnull(T09.S15ID,'''') = Isnull(O99.S15ID,'''') AND 
												Isnull(T09.S06ID,'''') = Isnull(O99.S06ID,'''') AND	Isnull(T09.S16ID,'''') = Isnull(O99.S16ID,'''') AND 
												Isnull(T09.S07ID,'''') = Isnull(O99.S07ID,'''') AND	Isnull(T09.S17ID,'''') = Isnull(O99.S17ID,'''') AND 
												Isnull(T09.S08ID,'''') = Isnull(O99.S08ID,'''') AND	Isnull(T09.S18ID,'''') = Isnull(O99.S18ID,'''') AND
												Isnull(T09.S09ID,'''') = Isnull(O99.S09ID,'''') AND	Isnull(T09.S19ID,'''') = Isnull(O99.S19ID,'''') AND 
												Isnull(T09.S10ID,'''') = Isnull(O99.S10ID,'''') AND	Isnull(T09.S20ID,'''') = Isnull(O99.S20ID,'''')
...
LEFT JOIN AT0128 AT0128_01 WITH (NOLOCK) on AT0128_01.StandardID = O99.S01ID AND AT0128_01.StandardTypeID = ''S01''
LEFT JOIN AT0128 AT0128_02 WITH (NOLOCK) on AT0128_02.StandardID = O99.S02ID AND AT0128_02.StandardTypeID = ''S02''
LEFT JOIN AT0128 AT0128_03 WITH (NOLOCK) on AT0128_03.StandardID = O99.S03ID AND AT0128_03.StandardTypeID = ''S03''
LEFT JOIN AT0128 AT0128_04 WITH (NOLOCK) on AT0128_04.StandardID = O99.S04ID AND AT0128_04.StandardTypeID = ''S04''
LEFT JOIN AT0128 AT0128_05 WITH (NOLOCK) on AT0128_05.StandardID = O99.S05ID AND AT0128_05.StandardTypeID = ''S05''
Left join AT0128 AT0128_06 WITH (NOLOCK) on AT0128_06.StandardID = O99.S06ID and AT0128_06.StandardTypeID = ''S06''
Left join AT0128 AT0128_07 WITH (NOLOCK) on AT0128_07.StandardID = O99.S07ID and AT0128_07.StandardTypeID = ''S07''
Left join AT0128 AT0128_08 WITH (NOLOCK) on AT0128_08.StandardID = O99.S08ID and AT0128_08.StandardTypeID = ''S08''
Left join AT0128 AT0128_09 WITH (NOLOCK) on AT0128_09.StandardID = O99.S09ID and AT0128_09.StandardTypeID = ''S09''
Left join AT0128 AT0128_10 WITH (NOLOCK) on AT0128_10.StandardID = O99.S10ID and AT0128_10.StandardTypeID = ''S10''
'
SET @sSQL4 = '
LEFT JOIN (SELECT 
		AT2007.DivisionID, 
...
EXEC(@sSQL + @sSQL0 + @sSQL1 + @sSQL2 + @sSQL3+@sSQL4)
--PRINT(@sSQL)
--PRINT( @sSQL0) 
--PRINT (@sSQL1)
--PRINT (@sSQL2)
