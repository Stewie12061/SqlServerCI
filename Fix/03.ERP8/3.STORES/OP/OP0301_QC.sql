IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[OP0301_QC]') AND  OBJECTPROPERTY(ID, N'IsProcedure') = 1)			
DROP PROCEDURE [DBO].[OP0301_QC]
GO
...
CREATE PROCEDURE [dbo].[OP0301_QC]  
...
SELECT  DISTINCT OV2300.DivisionID ,  
		...
		OV0306.Ana02IDAP, OV0306.ExportType, OV0306.NotesAP,
...
(SELECT SOrderID, Orders, InventoryName, Quantity, QuantityNum, ObjectID, StandardName01, Ana02IDAP, ExportType, NotesAP, DivisionID, InventoryTypeName, GroupID, GroupName
FROM OV0301
UNPIVOT
(
       Quantity
