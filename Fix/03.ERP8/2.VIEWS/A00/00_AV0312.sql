IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[AV0312]') AND OBJECTPROPERTY(ID, N'IsView') = 1)
DROP VIEW [DBO].[AV0312]
GO
...
SELECT	'' AS GiveUpID, AT9000.VoucherID, BatchID, TableID, AT9000.DivisionID, AT9000.TranMonth, AT9000.TranYear,
		...
		AT9000.ExchangeRate, ExchangeRateCN, PaymentExchangeRate,
		AT9000.Status, AT9000.VoucherTypeID, AT9000.VoucherNo, VoucherDate,
...
GROUP BY AT9000.VoucherID, BatchID, TableID, AT9000.DivisionID, AT9000.TranMonth, AT9000.TranYear,AT9000.TransactionTypeID,
		...
		, OT2001.ClassifyID, AT9000.DebitBankAccountID, AT9000.CreditBankAccountID 
