IF EXISTS (SELECT TOP 1 1 FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[DBO].[BV7000]') AND OBJECTPROPERTY(ID, N'IsView') = 1)  
DROP VIEW [DBO].[BV7000]  
GO  
...
--- Purpose: View so du theo seri, co lay VCNB
...
Select  D07.DivisionID, D07.TranMonth, D07.TranYear, D07.WareHouseID, 
	...
	D03.WareHouseName, Quantity, Quantity as SignQuantity, D02.S1, D02.S2, D02.S3, D02.S1 as CI1ID, D02.S2 as CI2ID, D02.S3 as CI3ID, 
...
Where D07.KindVoucherID in (1,3) and Isnull(D07.ReVoucherID,'') <> ''
...
Select  D07.DivisionID, D07.TranMonth, D07.TranYear,
	...
	Quantity, -Quantity as SignQuantity, D02.S1, D02.S2, D02.S3, D02.S1 as CI1ID, D02.S2 as CI2ID, D02.S3 as CI3ID, 
	D07.VoucherTypeID, D02.I01ID, D02.I02ID, D02.I03ID, D02.I04ID, D02.I05ID, D02.Specification,
	D02.Notes01, D02.Notes02, D02.Notes03,
	isnull(D03.IsTemp,0) as IsTemp,
	Case when  KindVoucherID = 3 then 3 else 0 end as KindVoucherID,
...
Where D07.KindVoucherID in (2,3) and Isnull(D07.ReVoucherID,'') <> ''
