...
BEGIN
	IF NOT EXISTS (SELECT TOP 1 1 FROM syscolumns col INNER JOIN sysobjects tab 
	ON col.id = tab.id WHERE tab.name = 'CRMT2114' AND col.name = 'MaterialGroupID') 
	ALTER TABLE CRMT2114 ADD MaterialGroupID NVARCHAR(50) NULL
END


-- Minh Dũng 08/11/2023: Bổ sung cột đơn giá gia quyền của nguyên vật liệu
IF EXISTS (SELECT * FROM sysobjects WHERE name = 'CRMT2114' AND xtype = 'U') 
BEGIN
	IF NOT EXISTS (SELECT TOP 1 1 FROM syscolumns col INNER JOIN sysobjects tab 
	ON col.id = tab.id WHERE tab.name = 'CRMT2114' AND col.name = 'UnitPriceAverage') 
	ALTER TABLE CRMT2114 ADD UnitPriceAverage DECIMAL(28, 8) NULL
END
...
BEGIN
	IF NOT EXISTS (SELECT TOP 1 1 FROM syscolumns col INNER JOIN sysobjects tab 
	ON col.id = tab.id WHERE tab.name = 'CRMT2114' AND col.name = 'InventoryID') 
	ALTER TABLE CRMT2114 ADD InventoryID NVARCHAR(50) NULL
END
...
BEGIN
	IF NOT EXISTS (SELECT TOP 1 1 FROM syscolumns col INNER JOIN sysobjects tab 
	ON col.id = tab.id WHERE tab.name = 'CRMT2114' AND col.name = 'NodeID') 
	ALTER TABLE CRMT2114 ADD NodeID NVARCHAR(50) NULL
END