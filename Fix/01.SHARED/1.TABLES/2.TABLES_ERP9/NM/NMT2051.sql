...
---- Nghiệp Vụ: Tiếp phẩm 3 bước ( detail: thông tin bữa ăn )
IF NOT EXISTS (SELECT TOP 1 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[NMT2051]') AND TYPE IN (N'U'))
BEGIN
CREATE TABLE [dbo].[NMT2051]
(
...
CONSTRAINT [PK_NMT2051] PRIMARY KEY CLUSTERED
(
  [APK] ASC
)
