...
IF NOT EXISTS (SELECT TOP 1 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[HT0330_1]') AND TYPE IN (N'U'))
BEGIN
     CREATE TABLE [dbo].[HT0330_1]
     (
    ...
    CONSTRAINT [PK_HT0330_1] PRIMARY KEY CLUSTERED
      (
      [APK],
	  [DivisionID]
      )
