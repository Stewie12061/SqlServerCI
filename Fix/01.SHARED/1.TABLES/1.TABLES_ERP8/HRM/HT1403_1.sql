...
IF NOT EXISTS (SELECT TOP 1 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[HT1403_1]') AND TYPE IN (N'U'))
BEGIN
     CREATE TABLE [dbo].[HT1403_1]
     (
    ...
    CONSTRAINT [PK_HT1403_1] PRIMARY KEY CLUSTERED
      (
      [DivisionID],
      [EmployeeID]
      )
