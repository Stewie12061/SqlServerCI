...
IF NOT EXISTS (SELECT TOP 1 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[HT2499]') AND TYPE IN (N'U'))
BEGIN
     CREATE TABLE [dbo].[HT2499]
     (
    ...
    CONSTRAINT [PK_HT2499] PRIMARY KEY CLUSTERED
      (
      [DivisionID],
      [EmpFileID]
      )
