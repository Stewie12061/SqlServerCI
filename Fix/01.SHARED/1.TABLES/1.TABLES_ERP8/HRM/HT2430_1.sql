...
IF NOT EXISTS (SELECT TOP 1 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[HT2430_1]') AND TYPE IN (N'U'))
BEGIN
     CREATE TABLE [dbo].[HT2430_1]
     (
    ...
    CONSTRAINT [PK_HT2430_1] PRIMARY KEY CLUSTERED
      (
      [APK],
	  [DivisionID]
      )
